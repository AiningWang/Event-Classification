...
class NewsClassification:
	...
	def Classification(self):
		"""
			classify
		"""
		predict_type = self.clf.predict(self.word_vector)
		self.predict_type = []
		"""
	...
	def execute(self):
		...
		while(1):
			...
			try:
				...
				collection.update({"_id": document["_id"]}, {"$set": {"classified": 1, "category": self.news_classify.predict_type, "event": self.event_classify.predict_type}})
